...
describe Generator, '#変換' do
  ...
  it '母音＋撥音（ん）を検査します' do
    g = Generator.new
    g.変換('あ', 左右: :左, 段: :下, 番号: 0, 撥音位置: {}).should eq([";", "あん"])
    g.変換('い', 左右: :左, 段: :下, 番号: 4, 撥音位置: {}).should eq(["x", "いん"])
    g.変換('う', 左右: :左, 段: :下, 番号: 3, 撥音位置: {}).should eq(["k", "うん"])
    g.変換('え', 左右: :左, 段: :下, 番号: 2, 撥音位置: {}).should eq(["j", "えん"])
    g.変換('お', 左右: :左, 段: :下, 番号: 1, 撥音位置: {}).should eq(["q", "おん"])
  end
  
  # かん，きん，くん，けん，こん など
  it '子音+母音+撥音（単体）を検査します' do
    g = Generator.new
    g.変換("か", 左右: :右, 段: :上, 番号: 2, 撥音位置: {左右: :左, 段: :下, 番号: 0}).
      should eq(["c;", "かん"])
  end
  
  it '子音+母音+撥音（一括）を検査します' do
    g = Generator.new
    g.変換("かきくけこ", 左右: :右, 段: :上, 番号: 2, 撥音位置: {左右: :左, 段: :下}).
