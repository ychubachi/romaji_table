...
拗音行.each do |行|
  ...
  変換 拗音(行, :い列, :ゃ行), 追加: 'ん', 開始鍵: 開始鍵[行], 中間鍵: 拗音鍵, 確定鍵: 左下 # きゃん
...
[:は行, :わ行].each do |行|
  ...
  変換 拗音, 追加: 'ん', 開始鍵: 開始鍵[行], 中間鍵: 拗音鍵, 確定鍵: 左下 # きゃん
...
#  変換 行, 追加: 'つ', 開始鍵: 開始鍵[行], 中間鍵: 人差指左, 確定鍵: 左中
  変換 行, 追加: 'つ', 開始鍵: 開始鍵[行], 中間鍵: 人差指左, 確定鍵: 左下
end

# H-4
あ行以外.each do |行|
  変換 行, 追加: 'っ', 開始鍵: 開始鍵[行], 中間鍵: 人差指左, 確定鍵: 左中
end

# 拗音を追加
拗音行.each do |行|
  変換 拗音(行, :い列, :ゃ行), 追加: 'っ', 開始鍵: 開始鍵[行], 中間鍵: 人差指左, 確定鍵: 左上
end
