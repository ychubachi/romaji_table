...
五十音合成(直音行 - [:あ行], 列: :え列, 行: :あ行).each do |かな, 行|
...
五十音合成(直音行 - [:あ行], 列: :え列, 行: :ぁ行).each do |かな, 行|
  変換(かな, 開始鍵: 子音鍵[行], 中間鍵: 左薬指, 確定鍵: シフト(右中段))
  変換(かな, 追加文字: 'ん', 開始鍵: 子音鍵[行], 中間鍵: 左薬指, 確定鍵: シフト(右下段))
  変換(かな, 追加文字: 'っ', 開始鍵: 子音鍵[行], 中間鍵: 左薬指, 確定鍵: シフト(右上段))
end
