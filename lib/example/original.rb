...
五十音合成(開拗音行, 列: :あ列, 行: :あ行).each do |かな, 行|
  変換(かな, 開始鍵: 子音鍵[行], 中間鍵: 左人指, 確定鍵: 右上段シフト)
end

五十音合成(開拗音行, 列: :う列, 行: :あ行).each do |かな, 行|
  変換(かな, 開始鍵: 子音鍵[行], 中間鍵: 左人指, 確定鍵: 右中段シフト)
end

五十音合成(開拗音行, 列: :お列, 行: :あ行).each do |かな, 行|
  変換(かな, 開始鍵: 子音鍵[行], 中間鍵: 左人指, 確定鍵: 右下段シフト)
end

## ================================================================
## 合拗音行 + 二重母音
## ================================================================
五十音合成(合拗音行, 列: :あ列, 行: :あ行).each do |かな, 行|
  変換(かな, 開始鍵: 子音鍵[行], 中間鍵: 左中指, 確定鍵: 右上段シフト)
end

五十音合成(合拗音行, 列: :う列, 行: :あ行).each do |かな, 行|
  変換(かな, 開始鍵: 子音鍵[行], 中間鍵: 左中指, 確定鍵: 右中段シフト)
end

五十音合成(合拗音行, 列: :お列, 行: :あ行).each do |かな, 行|
  変換(かな, 開始鍵: 子音鍵[行], 中間鍵: 左中指, 確定鍵: 右下段シフト)
end
...
# ## 未定義
# p 五十音合成([:た行, :だ行], 列: :え列, 行: :ゃ行) # テュ
# p 五十音合成([:は行, :ば行, :ぱ行], 列: :う列, 行: :ゃ行) # フュ
